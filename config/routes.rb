Rails.application.routes.draw do
  ...
  get "admin/tags/:id", to: "admin/tags#edit", as: "admin_edit_tag"
  post "admin/tags/:id", to: "admin/tags#update", as: "admin_update_tag"
  post "admin/tags/:id/merge", to: "admin/tags#merge", as: "admin_merge_tag"
  delete "admin/tags/:id", to: "admin/tags#destroy", as: "admin_destroy_tag"
