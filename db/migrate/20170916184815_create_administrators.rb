class CreateAdministrators < ActiveRecord::Migration[5.1]
  def up
    ...
    execute("ALTER TABLE administrators ADD COLUMN auth_token text DEFAULT gen_random_uuid() NOT NULL")
    execute("ALTER TABLE administrators ADD COLUMN grant_token text DEFAULT gen_random_uuid() NOT NULL")
