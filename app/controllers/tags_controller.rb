class TagsController < ApplicationController
  ...
  def submit
    ...
    @tag_submission.proposed_tags = params.fetch(:tags, [])
  ...
  def create
    ...
    @tag_submission.create_tags!(params.fetch(:tags, {}).values)
    flash[:notice] = "Your tags have been created"
    return redirect_to show_illustration_path(@tag_submission.illustration.slug)
  end

  def dispute
    @illustration_tag = IllustrationTag.find(params[:illustration_tag_id])
